...
export function CartProvider({
  ...
  // Se conserva la clave anterior para mantener compatibilidad
  // con los carritos previamente guardados.
  useEffect(() => {
  ...
  const addToCart = (
    ...
    setCart((prev) => {
      ...
      const totalPrice =
        newItem.pricePerPerson * newItem.people;
