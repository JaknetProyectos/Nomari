          ...
          <div className="flex animate-fade-in-up flex-col justify-between bg-[#182b3a] px-7 py-12 text-[#f2efe8] delay-150 sm:px-10 md:py-16 lg:px-12 xl:px-14">
            <div>
              ...
              <p className="mt-8 text-sm font-light leading-[1.9] text-[#f2efe8]/60 md:text-base">
                <T>
                  Garantice su presencia en los recintos gastronómicos más
                  exclusivos durante la justa deportiva. Nos encargamos de sus
                  accesos, reservas privadas y un ambiente inmejorable para que
                  su única preocupación sea celebrar.
                </T>
              </p>
            </div>
